        ...
        bool asShaderParam)
{
    ...
    if (val.IsHolding<SdfAssetPath>() && !asShaderParam) {  // rmantd edit : not work for shader parameter
...
SdfPathVector
PxrUsdKatanaUtils::FindMaterialPaths(const UsdStageRefPtr& stage)
{
    SdfPathVector result;
    for (UsdPrim prim: UsdPrimRange::AllPrims(stage->GetPseudoRoot()))
    {
