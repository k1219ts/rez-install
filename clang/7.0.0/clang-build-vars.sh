...
##  be installed.
##
# export CLANG_INSTALL_ROOT=/backstage/libs
# export CLANG_INSTALL_PREFIX=$CLANG_INSTALL_ROOT/clang/$CLANG_VERSION
export CLANG_INSTALL_PREFIX=${REZ_BUILD_INSTALL_PATH}
...
then
    ...
    export GCC_INSTALL_PREFIX=/opt/rh/devtoolset-6/root/usr
fi
